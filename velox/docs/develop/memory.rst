...
* L11-12: configure memory allocator type - use MmapAllocator if enabled, otherwise MallocAllocator. `Memory Allocator section <#memory-allocator>`_ describes these allocator types
...
* L20-38: configure memory arbitrator if enabled:
  ...
  - Configure comprehensive shared arbitrator parameters including capacity settings, arbitration timing, growth parameters, leak checking, reclaim settings, and global arbitration controls
